        ...
        <Container>
            <div className="grid-cols-2 sm-grid-cols-1 items-center gap-12 w-full py-50">
                <div className="pr-10 sm-pr-1">
                    <p className="mini-text text-dark border-ec w-max px-18 py-6 rounded-20 flex items-center gap-8 font-700 uppercase mb-15">
                        <Icon name="Settings" width="14" height="14" className="text-primary" />
                        Feature Collections
                    </p>
                    <h3 className="text-dark large-text font-600">
                        Delivering Innovative Businesses.
                    </h3>
                    <p className="text-gray small-text font-400 mt-12">
                        ...
                        {collection.thumbnails.map((thumb, idx) => (
                            <div key={idx}>
                                <Image
                                    src={thumb}
                                    alt={`Thumbnail ${idx + 1}`}
                                    className="flex w-full h-150 object-cover rounded-10"
                                />
                            </div>
                        ))}
                    </div>
                ...
                <div className="pl-10 sm-pl-1">
                    <Image
                        ...
                        className="flex w-full h-550 object-cover rounded-10"
                    />
                </div>
            </div>
        </Container>
